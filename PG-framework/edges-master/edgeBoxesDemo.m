...
if(~exist('/u/zhan2212/Desktop/2007 full/VOCdevkit/','dir')), return; end
split='test'; data=boxesData('resDir','/u/zhan2212/Desktop/2007 full/', 'dataDir'...
    ,'/u/zhan2212/Desktop/2007 full/VOCdevkit/', 'split','test');
nm='EdgeBoxes70'; opts.name=['/u/zhan2212/Desktop/2007 full/' nm '-' split '.mat'];
