function data = boxesDatafortest( varargin )
...
imDir=[o.dataDir 'VOC2012/JPEGImages/'];
gtDir=[o.dataDir 'VOC2012/Annotations/'];
imList=[o.dataDir 'VOC2012/ImageSets/Segmentation/' o.split '.txt'];
